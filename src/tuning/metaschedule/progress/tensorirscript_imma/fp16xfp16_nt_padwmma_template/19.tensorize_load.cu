                    ...
                    for (ax1_0_1: int32, 0, 1) {
                      for (ax0_1: int32, 0, 16) {
                        for (ax1_1: int32, 0, 16) {
                          block([16384, 16384], "B_shared_wmma.matrix_b") as [v0_2, v1_2] {
                            bind(v0_2, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (ax0_0_1*16)) + ax0_1))
                  ...
                  for (ax0_1_1: int32, 0, 16) {
                    for (ax1_1_1: int32, 0, 16) {
                      block([16384, 16384], "C_wmma.accumulator") as [v0_3, v1_3] {
                        bind(v0_3, ((((i_0_0*128) + (i_0_1*64)) + (ax0_0_2*16)) + ax0_1_1))
                        bind(v1_3, (((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + (ax1_0_2*16)) + ax1_1_1))
