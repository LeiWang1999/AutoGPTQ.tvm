                ...
                for (ax0_1: int32, 0, 256) {
                  for (ax1_1: int32, 0, 32) {
                    block([16384, 16384], "B_shared") as [v0_1, v1_1] {
                      bind(v0_1, (((j_0_0_0*4096) + (j_0_0_1*256)) + ax0_1))
                  ...
                  for (ax0_2: int32, 0, 64) {
                    for (ax1_2: int32, 0, 16) {
                      block([16384, 16384], "A_shared_wmma.matrix_a") as [v0_2, v1_2] {
                        bind(v0_2, (((i_0_0*128) + (i_0_1*64)) + ax0_2))
                  ...
                  for (ax0_3: int32, 0, 128) {
                    for (ax1_3: int32, 0, 16) {
                      block([16384, 16384], "B_shared_wmma.matrix_b") as [v0_3, v1_3] {
                        bind(v0_3, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + ax0_3))
              ...
              for (ax0_4: int32, 0, 64) {
                for (ax1_4: int32, 0, 128) {
                  block([16384, 16384], "C_wmma.accumulator") as [v0_4, v1_4] {
                    ...
                    bind(v1_4, ((((j_0_0_0*4096) + (j_0_0_1*256)) + (j_0_1*128)) + ax1_4))
