                    ...
                    for j_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                        for k_0_0 in range(128):
                            ...
                            for ax0, ax1 in T.grid(128, 64):
                                with T.block("B_shared"):
                                    v0 = T.axis.spatial(8192, j_0_0_0 * 1024 + j_0_0_1 * 128 + ax0)
                                    v1 = T.axis.spatial(8192, k_0_0 * 64 + ax1)
                                    T.reads(B[v0, v1])
                            ...
                            for k_0_1 in range(4):
                                for ax0, ax1 in T.grid(16, 16):
                                    with T.block("A_shared_wmma.matrix_a"):
                                        v0 = T.axis.spatial(32, i_0_1 * 16 + ax0)
                                        v1 = T.axis.spatial(8192, k_0_0 * 64 + k_0_1 * 16 + ax1)
                        ...
                        for ax0, ax1 in T.grid(16, 128):
                            with T.block("C_wmma.accumulator"):
                                v0 = T.axis.spatial(32, i_0_1 * 16 + ax0)
                                v1 = T.axis.spatial(8192, j_0_0_0 * 1024 + j_0_0_1 * 128 + ax1)
