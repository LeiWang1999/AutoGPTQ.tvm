            ...
            for (j_0_1: int32, 0, 1) "thread_binding" {
                ...
                for (k_0_1: int32, 0, 2) {
                  ...
                  for (ax0_0_1: int32, 0, 16) {
                    for (ax1_0_1: int32, 0, 1) {
                      block([512, 512], "B_shared_wmma.matrix_b_o") as [v0_o_1, v1_o_1] {
                        bind(v0_o_1, (((j_0_0_0*128) + (j_0_0_1*16)) + ax0_0_1))
                  ...
                  for (i_0_2: int32, 0, 2) {
                    for (j_0_2: int32, 0, 16) {
                      block([8, 512, tir.reduce_axis(0, 512)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                        bind(vi_o_1, (((i_0_0*8) + (i_0_1*2)) + i_0_2))
                        bind(vj_o_1, ((((j_0_0_0*128) + (j_0_0_1*16)) + (j_0_1*16)) + j_0_2))
              ...
              for (ax0_0_2: int32, 0, 2) {
                for (ax1_0_2: int32, 0, 16) {
                  block([8, 512], "C_wmma.accumulator_o") as [v0_o_2, v1_o_2] {
                    bind(v0_o_2, ((i_0_1*2) + ax0_0_2))
                    bind(v1_o_2, (((j_0_0_0*128) + (j_0_0_1*16)) + ax1_0_2))
