            ...
            for (j_0_1: int32, 0, 1) "thread_binding" {
              for (i_0_2_init: int32, 0, 1) {
                for (j_0_2_init: int32, 0, 8) {
                  block([2, 512], "B_init_o") as [vi_o, vj_o] {
                    bind(vi_o, (((i_0_0*2) + i_0_1) + i_0_2_init))
              ...
              for (k_0_0: int32, 0, 128) {
                ...
                for (k_0_1: int32, 0, 4) {
                  for (ax0_0: int32, 0, 1) {
                    for (ax1_0: int32, 0, 1) {
                      block([2, 512], "A_shared_wmma.matrix_a_o") as [v0_o, v1_o] {
                        bind(v0_o, (i_0_1 + ax0_0))
                  ...
                  for (ax0_0_1: int32, 0, 8) {
                    for (ax1_0_1: int32, 0, 1) {
                      block([512, 512], "B_shared_wmma.matrix_b_o") as [v0_o_1, v1_o_1] {
                  ...
                  for (i_0_2: int32, 0, 1) {
                    for (j_0_2: int32, 0, 8) {
                      block([2, 512, tir.reduce_axis(0, 512)], "B_update_o") as [vi_o_1, vj_o_1, vk_o] {
                        bind(vi_o_1, (((i_0_0*2) + i_0_1) + i_0_2))
              ...
              for (ax0_0_2: int32, 0, 1) {
                for (ax1_0_2: int32, 0, 8) {
                  block([2, 512], "C_wmma.accumulator_o") as [v0_o_2, v1_o_2] {
                    bind(v0_o_2, (i_0_1 + ax0_0_2))
