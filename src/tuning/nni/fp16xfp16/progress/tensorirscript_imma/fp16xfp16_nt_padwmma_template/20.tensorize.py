                    ...
                    for j_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init in T.grid(1, 8):
                            with T.block("B_init_o"):
                                vi_o = T.axis.spatial(2, i_0_0 * 2 + i_0_1 + i_0_2_init)
                                vj_o = T.axis.spatial(512, j_0_0_0 * 64 + j_0_0_1 * 8 + j_0_1 * 8 + j_0_2_init)
                                T.reads()
                            ...
                            for k_0_1 in range(4):
                                for ax0_0, ax1_0 in T.grid(1, 1):
                                    with T.block("A_shared_wmma.matrix_a_o"):
                                        v0_o = T.axis.spatial(2, i_0_1 + ax0_0)
                                        v1_o = T.axis.spatial(512, k_0_0 * 4 + k_0_1 + ax1_0)
                                ...
                                for ax0_0, ax1_0 in T.grid(8, 1):
                                    with T.block("B_shared_wmma.matrix_b_o"):
                                        v0_o = T.axis.spatial(512, j_0_0_0 * 64 + j_0_0_1 * 8 + ax0_0)
                                        v1_o = T.axis.spatial(512, k_0_0 * 4 + k_0_1 + ax1_0)
                                ...
                                for i_0_2, j_0_2 in T.grid(1, 8):
                                    with T.block("B_update_o"):
                                        vi_o = T.axis.spatial(2, i_0_0 * 2 + i_0_1 + i_0_2)
                                        vj_o = T.axis.spatial(512, j_0_0_0 * 64 + j_0_0_1 * 8 + j_0_1 * 8 + j_0_2)
                                        vk_o = T.axis.reduce(512, k_0_0 * 4 + k_0_1)
                        ...
                        for ax0_0, ax1_0 in T.grid(1, 8):
                            with T.block("C_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(2, i_0_1 + ax0_0)
                                v1_o = T.axis.spatial(512, j_0_0_0 * 64 + j_0_0_1 * 8 + ax1_0)
