                ...
                for i_0_1 in T.thread_binding(4, thread="threadIdx.y"):
                    for j_0_1 in T.thread_binding(1, thread="threadIdx.z"):
                        for i_0_2_init, j_0_2_init, i_1_init, j_1_init in T.grid(2, 16, 16, 16):
                            with T.block("B_init"):
                                vi = T.axis.spatial(128, i_0_0 * 128 + i_0_1 * 32 + i_0_2_init * 16 + i_1_init)
                                vj = T.axis.spatial(8192, j_0_0_0 * 2048 + j_0_0_1 * 256 + j_0_1 * 256 + j_0_2_init * 16 + j_1_init)
                                T.reads()
                            ...
                            for k_0_1 in range(2):
                                for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(2, 1, 16, 16):
                                    with T.block("A_shared_wmma.matrix_a"):
                                        v0 = T.axis.spatial(128, i_0_1 * 32 + ax0_0 * 16 + ax0_1)
                                ...
                                for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(16, 1, 16, 16):
                                    with T.block("B_shared_wmma.matrix_b"):
                                        v0 = T.axis.spatial(8192, j_0_0_0 * 2048 + j_0_0_1 * 256 + ax0_0 * 16 + ax0_1)
                                        v1 = T.axis.spatial(8192, k_0_0 * 32 + k_0_1 * 16 + ax1_0 * 16 + ax1_1)
                        ...
                        for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(2, 16, 16, 16):
                            with T.block("C_wmma.accumulator"):
                                v0 = T.axis.spatial(128, i_0_1 * 32 + ax0_0 * 16 + ax0_1)
                                v1 = T.axis.spatial(8192, j_0_0_0 * 2048 + j_0_0_1 * 256 + ax1_0 * 16 + ax1_1)
