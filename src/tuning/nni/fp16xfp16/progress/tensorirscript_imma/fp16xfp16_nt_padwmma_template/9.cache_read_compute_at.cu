                ...
                for (ax0_1: int32, 0, 256) {
                  for (ax1_1: int32, 0, 32) {
                    block([8192, 8192], "B_shared") as [v0_1, v1_1] {
                      bind(v0_1, (((j_0_0_0*2048) + (j_0_0_1*256)) + ax0_1))
                  ...
                  for (ax0_3: int32, 0, 256) {
                    for (ax1_3: int32, 0, 16) {
                      block([8192, 8192], "B_shared_wmma.matrix_b") as [v0_3, v1_3] {
                        bind(v0_3, (((j_0_0_0*2048) + (j_0_0_1*256)) + ax0_3))
              ...
              for (ax0_4: int32, 0, 32) {
                for (ax1_4: int32, 0, 256) {
                  block([128, 8192], "C_wmma.accumulator") as [v0_4, v1_4] {
                    bind(v0_4, ((i_0_1*32) + ax0_4))
                    bind(v1_4, (((j_0_0_0*2048) + (j_0_0_1*256)) + ax1_4))
