        ...
        for j_0 in T.thread_binding(256, thread="blockIdx.x"):
            for i_1_0 in T.thread_binding(4, thread="threadIdx.z"):
                for j_1_0 in T.thread_binding(16, thread="threadIdx.y"):
                    for i_1_1_0_init, j_1_1_0_init, i_1_1_1_init, j_1_1_1_init in T.grid(1, 1, 16, 16):
                        with T.block("B_init"):
                            vi = T.axis.spatial(16384, i_0 * 64 + i_1_0 * 16 + i_1_1_0_init * 16 + i_1_1_1_init)
                            vj = T.axis.spatial(16384, j_0 * 64 + j_1_0 * 4 + (j_1_1_0_init * 16 + j_1_1_1_init))
                            T.where(j_1_1_0_init * 16 + j_1_1_1_init < 4)
                            T.reads()
                        ...
                        for k_1_0 in range(1):
                            for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(1, 1, 16, 16):
                                with T.block("A_shared_wmma.matrix_a"):
                                    v0 = T.axis.spatial(16384, i_0 * 64 + i_1_0 * 16 + ax0_0 * 16 + ax0_1)
                                    v1 = T.axis.spatial(16384, k_0 * 16 + ax1_0 * 16 + ax1_1)
                                    T.reads(A_shared[v0, v1])
                                    T.writes(A_shared_wmma_matrix_a[v0, v1])
                                    A_shared_wmma_matrix_a[v0, v1] = A_shared[v0, v1]
                            for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(1, 1, 16, 16):
                                with T.block("B_shared_wmma.matrix_b"):
                                    v0 = T.axis.spatial(16384, j_0 * 64 + j_1_0 * 4 + ax0_0 * 16 + ax0_1)
                                    v1 = T.axis.spatial(16384, k_0 * 16 + ax1_0 * 16 + ax1_1)
                                    T.where(j_0 * 64 + j_1_0 * 4 + (ax0_0 * 16 + ax0_1) < 16384)
                                    T.reads(B_shared[v0, v1])
                                    T.writes(B_shared_wmma_matrix_b[v0, v1])
                                    B_shared_wmma_matrix_b[v0, v1] = B_shared[v0, v1]
                            for i_1_1_0, j_1_1_0, i_1_1_1, j_1_1_1, k_1_1 in T.grid(1, 1, 16, 16, 16):
                                with T.block("B_update"):
                                    vi = T.axis.spatial(16384, i_0 * 64 + i_1_0 * 16 + i_1_1_0 * 16 + i_1_1_1)
                                    vj = T.axis.spatial(16384, j_0 * 64 + j_1_0 * 4 + (j_1_1_0 * 16 + j_1_1_1))
                                    vk = T.axis.reduce(16384, k_0 * 16 + k_1_0 * 16 + k_1_1)
                                    T.where(j_1_1_0 * 16 + j_1_1_1 < 4)
                    ...
                    for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(1, 1, 16, 16):
                        with T.block("C_wmma.accumulator"):
                            v0 = T.axis.spatial(16384, i_0 * 64 + i_1_0 * 16 + ax0_0 * 16 + ax0_1)
                            v1 = T.axis.spatial(16384, j_0 * 64 + j_1_0 * 4 + ax1_0 * 16 + ax1_1)
                            T.where(j_0 * 64 + j_1_0 * 4 + (ax1_0 * 16 + ax1_1) < 16384)
