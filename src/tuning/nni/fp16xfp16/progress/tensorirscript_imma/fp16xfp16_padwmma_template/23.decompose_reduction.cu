      ...
      for (j_0: int32, 0, 256) "thread_binding" {
        for (i_1_0: int32, 0, 4) "thread_binding" {
          for (j_1_0: int32, 0, 16) "thread_binding" {
            for (i_1_1_0_init: int32, 0, 1) {
              for (j_1_1_0_init: int32, 0, 1) {
                for (i_1_1_1_init: int32, 0, 16) {
                  for (j_1_1_1_init: int32, 0, 16) {
                    block([16384, 16384], "B_init") as [vi, vj] {
                      where((((j_1_1_0_init*16) + j_1_1_1_init) < 4))
                      bind(vi, ((((i_0*64) + (i_1_0*16)) + (i_1_1_0_init*16)) + i_1_1_1_init))
                      bind(vj, (((j_0*64) + (j_1_0*4)) + ((j_1_1_0_init*16) + j_1_1_1_init)))
                      tir.reads([])
                      ...
                      for (j_1_1_1: int32, 0, 16) {
                        for (k_1_1: int32, 0, 16) {
                          block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                            ...
                            bind(vi_1, ((((i_0*64) + (i_1_0*16)) + (i_1_1_0*16)) + i_1_1_1))
                            bind(vj_1, (((j_0*64) + (j_1_0*4)) + ((j_1_1_0*16) + j_1_1_1)))
