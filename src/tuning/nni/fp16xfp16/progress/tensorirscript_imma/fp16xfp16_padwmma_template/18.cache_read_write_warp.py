                ...
                for j_1_0 in T.thread_binding(16, thread="threadIdx.y"):
                        ...
                        for k_1_0 in range(1):
                            for ax0, ax1 in T.grid(16, 16):
                                with T.block("A_shared_wmma.matrix_a"):
                                    v0 = T.axis.spatial(16384, i_0 * 64 + i_1_0 * 16 + ax0)
                            ...
                            for ax0, ax1 in T.grid(16, 16):
                                with T.block("B_shared_wmma.matrix_b"):
                                    v0 = T.axis.spatial(16384, j_0 * 64 + j_1_0 * 4 + ax0)
                                    v1 = T.axis.spatial(16384, k_0 * 16 + ax1)
                                    T.where(j_0 * 64 + j_1_0 * 4 + ax0 < 16384)
                    ...
                    for ax0, ax1 in T.grid(16, 16):
                        with T.block("C_wmma.accumulator"):
                            v0 = T.axis.spatial(16384, i_0 * 64 + i_1_0 * 16 + ax0)
                            v1 = T.axis.spatial(16384, j_0 * 64 + j_1_0 * 4 + ax1)
                            T.where(j_0 * 64 + j_1_0 * 4 + ax1 < 16384)
