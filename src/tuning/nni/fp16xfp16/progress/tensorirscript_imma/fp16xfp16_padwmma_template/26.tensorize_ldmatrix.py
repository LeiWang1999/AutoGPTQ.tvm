                ...
                for j_1_0 in T.thread_binding(2, thread="threadIdx.y"):
                    for i_1_1_0_init, j_1_1_0_init, i_1_1_1_init, j_1_1_1_init in T.grid(4, 4, 16, 16):
                        with T.block("B_init"):
                            ...
                            vj = T.axis.spatial(16384, j_0 * 128 + j_1_0 * 64 + j_1_1_0_init * 16 + j_1_1_1_init)
                            T.reads()
                    ...
                    for k_0 in range(1024):
                        ...
                        for k_1_0 in range(1):
                            ...
                            for i_1_1_0, j_1_1_0, i_1_1_1, j_1_1_1, k_1_1 in T.grid(4, 4, 16, 16, 16):
                                with T.block("B_update"):
                                    vi = T.axis.spatial(16384, i_0 * 128 + i_1_0 * 64 + i_1_1_0 * 16 + i_1_1_1)
                                    vj = T.axis.spatial(16384, j_0 * 128 + j_1_0 * 64 + j_1_1_0 * 16 + j_1_1_1)
                    ...
                    for ax0_0, ax1_0, ax0_1, ax1_1 in T.grid(4, 4, 16, 16):
                        with T.block("C_wmma.accumulator"):
                            ...
                            v1 = T.axis.spatial(16384, j_0 * 128 + j_1_0 * 64 + ax1_0 * 16 + ax1_1)
