                ...
                for (ax0: int32, 0, 16) {
                  for (ax1: int32, 0, 16) {
                    block([16384, 16384], "A_shared_wmma.matrix_a") as [v0_2, v1_2] {
                      bind(v0_2, (((i_0*64) + (i_1_0*16)) + ax0))
                      bind(v1_2, ((k_0*16) + ax1))
                ...
                for (ax0_1: int32, 0, 16) {
                  for (ax1_1: int32, 0, 16) {
                    block([16384, 16384], "B_shared_wmma.matrix_b") as [v0_3, v1_3] {
                      where(((((j_0*64) + (j_1_0*4)) + ax0_1) < 16384))
                      bind(v0_3, (((j_0*64) + (j_1_0*4)) + ax0_1))
                      bind(v1_3, ((k_0*16) + ax1_1))
            ...
            for (ax0_2: int32, 0, 16) {
              for (ax1_2: int32, 0, 16) {
                block([16384, 16384], "C_wmma.accumulator") as [v0_4, v1_4] {
                  where(((((j_0*64) + (j_1_0*4)) + ax1_2) < 16384))
                  bind(v0_4, (((i_0*64) + (i_1_0*16)) + ax0_2))
                  bind(v1_4, (((j_0*64) + (j_1_0*4)) + ax1_2))
