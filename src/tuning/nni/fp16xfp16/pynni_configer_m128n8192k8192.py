...
search_space = {
    "block_row_warps": {"_type": "choice", "_value": [1, 2, 4, 8]},
    "block_col_warps": {"_type": "choice", "_value": [1, 2, 4, 8, 16]},    
    "BM": {"_type": "choice", "_value": [64, 128]},
...
experiment.config.trial_command = f'python3 ./fp16xfp16_nt_padwmma_template.py --M {M} --N {N} --K {K}'
