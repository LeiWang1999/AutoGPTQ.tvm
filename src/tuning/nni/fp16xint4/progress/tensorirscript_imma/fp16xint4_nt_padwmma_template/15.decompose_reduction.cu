                  ...
                  for (i_1_init: int32, 0, 16) {
                    for (j_1_init: int32, 0, 16) {
                      block([16384, 16384], "B_init") as [vi, vj] {
                        bind(vi, ((((i_0_0*16) + (i_0_1*16)) + (i_0_2_init*16)) + i_1_init))
                        ...
                        for (j_1: int32, 0, 16) {
                          for (k_1: int32, 0, 16) {
                            block([16384, 16384, tir.reduce_axis(0, 16384)], "B_update") as [vi_1, vj_1, vk] {
                              bind(vi_1, ((((i_0_0*16) + (i_0_1*16)) + (i_0_2*16)) + i_1))
                              bind(vj_1, (((((j_0_0_0*1024) + (j_0_0_1*128)) + (j_0_1*128)) + (j_0_2*16)) + j_1))
                              bind(vk, (((k_0_0*64) + (k_0_1*16)) + k_1))
                              tir.reads([C_wmma.accumulator[vi_1, vj_1], A_shared_wmma.matrix_a[vi_1, vk], B_decompress_shared_wmma.matrix_b[vj_1, vk]])
                              tir.writes([C_wmma.accumulator[vi_1, vj_1]])
                              C_wmma.accumulator[vi_1, vj_1] = (C_wmma.accumulator[vi_1, vj_1] + (A_shared_wmma.matrix_a[vi_1, vk]*B_decompress_shared_wmma.matrix_b[vj_1, vk]))
                          }
                        }
                      }
                    }
