                    ...
                    for (ax1_0_1: int32, 0, 1) {
                      for (ax0_1: int32, 0, 16) {
                        for (ax1_1: int32, 0, 16) {
                          block([16384, 16384], "B_decompress_shared_wmma.matrix_b") as [v0_2, v1_2] {
                            bind(v0_2, ((((j_0_0_0*1024) + (j_0_0_1*128)) + (ax0_0_1*16)) + ax0_1))
                            bind(v1_2, ((((k_0_0*64) + (k_0_1*16)) + (ax1_0_1*16)) + ax1_1))
                            tir.reads([B_decompress_shared[v0_2, v1_2]])
                            tir.writes([B_decompress_shared_wmma.matrix_b[v0_2, v1_2]])
                            B_decompress_shared_wmma.matrix_b[v0_2, v1_2] = B_decompress_shared[v0_2, v1_2]
                        }
                      }
                    }
                  }
                ...
                for (ax1_0_2: int32, 0, 8) {
                  for (ax0_1_1: int32, 0, 16) {
                    for (ax1_1_1: int32, 0, 16) {
                      block([16384, 16384], "C_wmma.accumulator") as [v0_3, v1_3] {
                        bind(v0_3, (((i_0_0*16) + (ax0_0_2*16)) + ax0_1_1))
                        bind(v1_3, ((((j_0_0_0*1024) + (j_0_0_1*128)) + (ax1_0_2*16)) + ax1_1_1))
