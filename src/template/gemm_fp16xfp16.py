...
for params in configurations:
    ...
    fname = f"gemm_fp16xfp16_M{params['M']}_{params['BM']}x{params['BN']}x{params['BK']}"
    # create log path
    ...
    code = code.replace("main_kernel0", f"tir_halfxhalf_tensorop_{BM}x{BN}x{BK}x{stage}_align{vec}")
